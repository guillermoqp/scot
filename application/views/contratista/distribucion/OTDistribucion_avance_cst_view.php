    ...
    <form role="form" accept-charset="utf-8" enctype="multipart/form-data" method="post" action="<?php echo str_replace('/index.php', '', current_url()) . "/guardar"; ?>">
        <div id="impresion">
                        ...
                        <table id="ciclos" class="table table-bordered table-striped">
                            <thead>
                                <tr Class="info" role="row">
                                    ...
                                    <th>% Avance</th>
                                    <th>N° Observaciones de Distribucion</th>
                                </tr>
                            </thead>
                            <tbody>
            ...
            <div class="row no-print invoice-info">
                <div class="col-xs-12">
                    <h5>Sub Ordenes de Trabajo de Distribucion de Recibos y Comunicaciones ( Asignadas a cada Distribuidor )</h5>
                    <?php foreach ($ciclos as $ciclo) { ?>
                                ...
                                <tbody>
                                    <?php foreach ($ciclo['distribuidores'] as $distribuidor) { ?>
                                        <tr>
                                            ...
                                            <td>
                                                <a href="<?php echo base_url() .'cst/distribucion/orden/avance/'.$OTTomaEstado['OrtId'].'/suborden/'.$distribuidor['SodCod']?>">
