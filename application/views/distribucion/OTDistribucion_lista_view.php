        ...
        <div class="col-xs-12">
            ...
            <div class="row">
                <div class="col-md-4">
                    <div class="form-group">
                        <div class="control-group">
                            <a href="<?php echo base_url() ?>distribucion/orden/nuevo" class="btn btn-info btn-flat"><i class="fa fa-pencil"></i> Registrar Nueva Orden (Continua)</a>
                        </div>
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="form-group">
                        <div class="control-group">
                            <a href="<?php echo base_url() ?>distribucion/orden/nuevo_d" class="btn btn-info btn-flat"><i class="fa fa-pencil"></i> Registrar Nueva Orden (Dispersa)</a>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        <div class="control-group">
                            <a href="<?php echo base_url() ?>distribucion/reportes/control" class="btn btn-success btn-flat <?php echo (empty($ordenesTrabajo)) ? 'disabled' : ''; ?>"><i class="fa fa-calendar"></i> Reporte Control Mensual de Distribuciones</a>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="box">
                <div class="box-header">
                    <h3 class="box-title">Ordenes de Trabajo Registradas de Distribución de Recibos y Comunicaciones al Cliente</h3>                             
                </div><!-- /.box-header -->
                            ...
                            <?php foreach ($ordenesTrabajo as $ordenTrabajo): ?>
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a href="<?php echo base_url() . 'distribucion/orden/avance/' . $ordenTrabajo['OrtId'] ?>">
                                        ...
                                        <a href="<?php echo base_url() . 'distribucion/orden/avance/' . $ordenTrabajo['OrtId'] ?>">
                                            ...
                                            <div class="progress xs progress-striped active">
                                                <div class="progress-bar progress-bar-<?php echo $estilos[$ordenTrabajo['DprCod']]; ?>" style="width: <?php echo $ordenTrabajo['avanceSupervision']; ?>%"></div>
                                            </div>
                                        </a>
                                    ...
                                    <td>
                                         <?php if ($this->acceso_cls->tienePermiso('ver_orden_lectura')) { ?>
                                            <a href="<?php echo base_url() . 'distribucion/orden/ver/' . $ordenTrabajo['OrtId']; ?>" class="btn btn-default btn-flat" data-toggle="tooltip" data-placement="bottom" title="Ver">
                                                <i class="fa fa-eye"></i></a>
                                        <?php } ?>
                                        <?php if ($this->acceso_cls->tienePermiso('editar_orden_lectura')) { ?>
                                            <a href="<?php echo base_url() . 'distribucion/orden/editar/' . $ordenTrabajo['OrtId']; ?>" class="btn btn-default btn-flat" data-toggle="tooltip" data-placement="bottom" title="Editar">
                                        ...
                                        <?php } ?>
                                        <?php if ($this->acceso_cls->tienePermiso('ver_orden_lectura')) { ?>  
                                            <a href="<?php echo base_url() . 'distribucion/orden/avance/' . $ordenTrabajo['OrtId'] ?>" class="btn btn-default btn-flat" data-toggle="tooltip" data-placement="bottom" title="Avance">
                                            <span class="glyphicon glyphicon-chevron-right"></span>
                                        <?php } ?>   
                                                                              
                                        <?php if ($this->acceso_cls->tienePermiso('penalizar_orden_lectura')) { ?>
                                            <a href="<?php echo base_url() . 'distribucion/orden/' . $ordenTrabajo['OrtId'] . '/penalizaciones'; ?>" class="btn btn-default btn-flat" data-toggle="tooltip" data-placement="bottom" title="Penalizaciones">
...
<script type="text/javascript">
    $(document).ready(function ()
    {
        ...
        $(document).on('click', 'a', function (event)
        {
            ...
            $('#idelim').attr('action', "<?php echo base_url() . 'distribucion/orden/eliminar/'; ?>" + ordenTrabajoId);
        });
    });
</script>