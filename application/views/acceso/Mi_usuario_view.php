                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <div class="control-group">
                                        ...
                                        <?php } ?>
                                            <input type="file" class="upload" name="foto" id="foto" <?php echo (isset($usuarioEdit)) ? '' : 'required'; ?>>  
                        ...
                        <div class="box-body">
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <div class="control-group">
                                            <label>Usuario: <h3><?php echo (isset($usuarioEdit)) ? $usuarioEdit['UsrNomCt'] : ''; ?></h3></label>
                                        </div>
                                    </div>
                                </div> 
                            </div> 
