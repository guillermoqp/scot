                ...
                <div class="box">
                                ...
                                <?php if (isset($esUltimoNivel)) { ?>
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <select id="buscarGruposPredio" name="buscarGruposPredio" class="form-control" onchange="enviarForm('buscarGruposPredio')" <?php echo isset($_SESSION['orden']['bloqueado']) ? 'readonly' : '' ?> >
                                                        <?php foreach ($gruposPredio as $grupoPredio) { ?>
                                                            <option value="<?php echo $grupoPredio['GprId']; ?>" <?php echo ($_SESSION['orden']['buscarGruposPredio'] == $grupoPredio['GprId']) ? 'selected' : '' ?> <?php echo isset($_SESSION['orden']['bloqueado']) ? 'readonly' : '' ?>><?php echo $grupoPredio['GprCod']; ?></option>
                                                            <?php } ?>
                                                    </select> 
                                                </div>
                                            </div>
                                    ...
                                    <div class="col-md-3">
                                        ...
                                        <div class="form-group">
                                            <div class="control-group">
                                                <div class="input-group">
                                                    <select id="gruposPredio" name="gruposPredio[]" class="select2" multiple="multiple" data-placeholder="Seleccione SubCiclo" <?php echo isset($_SESSION['orden']['bloqueado']) ? 'readonly' : '' ?> style="width: 100%;">
                                        ...
                                        <div class="form-group">
                                            <div class="control-group">
                                                <div class="input-group">
                                                    ...
                                                    <select id="gruposPredio" name="gruposPredio" class="form-control" onchange="enviarForm('gruposPredio')" <?php echo isset($_SESSION['orden']['bloqueado']) ? 'readonly' : '' ?> >
                                                        <?php if (!isset($_SESSION['orden']['gruposPredio'])) { ?>
                                                            <?php foreach ($gruposPredio as $grupoPredio) { ?>
                                                            <option value="<?php echo $grupoPredio['GprId']; ?>" <?php echo ($_SESSION['orden']['gruposPredio'] == $grupoPredio['GprId']) ? 'selected' : '' ?> <?php echo isset($_SESSION['orden']['bloqueado']) ? 'readonly' : '' ?>><?php echo $grupoPredio['GprCod']; ?></option>
                                                            <?php } ?>
                                                        <?php } else { ?>
                                                        <?php foreach ($gruposPredio as $grupoPredio) { ?>
                                                            <option value="<?php echo $grupoPredio['GprId']; ?>" <?php echo ($_SESSION['orden']['gruposPredio'] == $grupoPredio['GprId']) ? 'selected' : '' ?> <?php echo isset($_SESSION['orden']['bloqueado']) ? 'readonly' : '' ?>><?php echo $grupoPredio['GprCod']; ?></option>
                                    ...
                                    <div class="control-group">
                                        ...
                                        <div class="controls">
                                            <div class="input-group">
                                                ...
                                                <input id="OrtNum" name="OrtNum" type="text" class="form-control" value="<?php echo $_SESSION['orden']['numero']; ?>" readonly/>
                                            </div><!-- /.input group -->
                                        </div>
                                    </div>
                                </div>    
                                ...
                                <div class="form-group">
                                    <div class="control-group">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input id="OrtEntr" name="OrtEntr" type="text" class="form-control" value="<?php echo $_SESSION['orden']['entregado']; ?>" readonly=""/>
                                        </div>
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <textarea id="OrtDes" name="OrtDes" class="form-control" rows="3" ><?php echo $_SESSION['orden']['descripcion']; ?></textarea>
                                    </div>       
                                </div>
                            </div> 
                        </div>
                                        ...
                                        <div class="input-group">
                                            ...
                                            <select id="OrtAnio" name="OrtAnio" class="form-control" onchange="enviarForm('anio')" <?php echo isset($_SESSION['orden']['bloqueado']) ? 'readonly' : '' ?> >
                                                <?php foreach ($anios as $anioitem) { ?>
                                                    <option value="<?php echo $anioitem ?>"<?php echo ($_SESSION['orden']['anio'] == $anioitem) ? 'selected' : ''; ?>><?php echo $anioitem ?></option>
                                                <?php } ?>
                                            </select>
                                        </div><!-- /.input group -->
                                    </div> 
                                ...
                                <div class="form-group">
                                    <div class="control-group">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <select id="OrtPrd" name="OrtPrd" class="form-control" onchange="enviarForm('periodo')" <?php echo isset($_SESSION['orden']['bloqueado']) ? 'readonly' : '' ?> >
                                                <?php foreach ($periodos as $periodo) { ?>
                                                    <option value="<?php echo $periodo['PrdId'] ?>"<?php echo ($_SESSION['orden']['periodo'] == $periodo['PrdId']) ? 'selected' : ''; ?>><?php echo $periodo['PrdCod'] ?></option>
                                                <?php } ?>
                                            </select>
                                        </div>
                                    </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input id="OrtFchEj" name="OrtFchEj" type="text" class="form-control" onchange="enviarForm('fecha')" data-toggle="tooltip" title="Dato necesario para ingresar Fecha y hora Máxima de Recepción"  <?php echo isset($_SESSION['orden']['bloqueado']) ? 'readonly' : '' ?>/>   
                                    </div>
                                </div>
                            </div>
                        </div>    
                    ...
                    <div class="box">
                        ...
                        <div class="box-body">
                            <div class="row"> 
                                <div class="col-md-3">
                                    Rendimiento por Lecturista:<input type="text" class="form-control" value="<?php echo $_SESSION['orden']['rendimiento']; ?>" disabled=""/>
                                </div>    
                                <div class="col-md-3">
                                    N° Total de Lecturistas :<input type="text" class="form-control" value="<?php echo $_SESSION['orden']['totalLecturistas']; ?>" disabled=""/>
                                </div>
                                <div class="col-md-3">
                                    N° Subordenes:<input type="text" class="form-control" value="<?php echo $_SESSION['orden']['subordenesAcumulado']; ?>" disabled=""/>
                                </div> 
                                <div class="col-md-3">
                                    Lecturas Totales de la Orden:<input type="text" class="form-control" value="<?php echo $_SESSION['orden']['lecturasAcumulado']; ?>" disabled=""/>
                                </div> 
                            </div><br>
                            <?php #var_dump($_SESSION['orden']['detalle']) ?>
                            <div class="row">
                                <div class="col-md-12 table-responsive">
                                    <table id="ciclos" class="table table-bordered table-striped">
                                        ...
                                        <tbody>
                                            <?php
                                            $cant = 0;
                                            foreach ($_SESSION['orden']['detalle'] as $dia => $ordenDia) {
                                                ?>
                                                <tr>
                                                    <td> <?php echo $dia ?></td>
                ...
                <div class="box">
                    <div class="box-body">
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <textarea id="OrtObs" name="OrtObs" class="form-control" rows="3"><?php echo $_SESSION['orden']['observaciones']; ?></textarea>
                                    </div>       
                                </div>
                            </div> 
                        </div>
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    <input type="checkbox" value="suborden" name="supervision" class="flat-red" <?php echo $_SESSION['orden']['supervision'] ? 'checked' : '' ?>>Añadir Suborden de Supervisión y Control de Calidad de las Lecturas.
                                    <br> ( <b><?php echo isset($_SESSION['orden']['tamanioMuestra']) ? 'Tamaño Muestra : '.$_SESSION['orden']['tamanioMuestra'].' Lecturas.' : '' ?></b> )
                                </div>
                            </div>
                        </div>
                    </div>
...
$(document).ready(function ()
{
    ...
    <?php if(is_array($_SESSION['orden']['gruposPredio'])) { ?>
    var subciclosSeleccionados = <?php echo json_encode($_SESSION['orden']['gruposPredio']); ?>; 
    ...
    $(document).on("click", "#detalle", function ()
    {
        ...
        window.open("<?php echo base_url() . 'toma_estado/orden/nuevo/detalle_ciclo/'; ?>" + idCiclo, "_blank", "toolbar=yes, scrollbars=yes, resizable=yes, top=50, left=80, width=1100, height=800");
    });
