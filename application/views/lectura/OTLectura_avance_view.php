        ...
        <div id="impresion">
            ...
            <div class="row invoice-info">
                <div class="col-xs-12">
                    ...
                    <h5>Orden de Trabajo de Toma de Estado de suministros a ejecutar</h5>
                        ...
                        <table id="ciclos" class="table table-bordered table-striped">
                            <thead>
                                <tr Class="info" role="row">
                                    ...
                                    <th>Localidades</th>
                                    <th>N° Lecturistas Asignados</th>
                                    <th>N° Lecturas totales</th>
                                    <th>N° Lecturas realizadas</th>
                                    <th>% Avance</th>
                                    <th>N° Observaciones de Lectura</th>
                                </tr>
                            </thead>
                            <tbody>
                                <?php foreach ($ciclos as $ciclo): ?>
                                    <tr>
                                        ...
                                        <td><?php echo $ciclo['cantLecturistas']; ?></td>
                                        <td><?php echo $ciclo['cantLecturas']; ?></td>
                                        <td><?php echo $ciclo['cantLecturasEj']; ?></td>
                                        <td>
            ...
            <div class="row no-print invoice-info">
                <div class="col-xs-12">
                    <h5>Sub Ordenes de Trabajo de Toma de Estado de suministros ( Asignadas a cada Lecturista )</h5>
                    <?php foreach ($ciclos as $ciclo) { ?>
                            ...
                            <table id="detalleCiclo<?php echo $ciclo["GprCod"]; ?>" class="table table-bordered table-striped">
                                <thead>
                                    <tr Class="info" role="row">
                                        <th>Nro. Suborden</th>
                                        <th>Lecturista</th>
                                        <th>Lecturas totales</th>
                                        <th>Fecha de ejecución</th>
                                        <th>Lecturas ejecutadas</th>
                                        <th>Avance</th>
                                        <th>Observaciones</th>
                                    </tr>
                                </thead>
                                <tbody>
                                    <?php foreach ($ciclo['lecturistas'] as $lecturista) { ?>
                                        <tr <?php echo ($lecturista['supervisor']==true)? 'class="bg-red-active color-palette"' : ''; ?>>
                                            <td><?php echo $lecturista['Numero']; ?></td>
                                            <td><?php echo $lecturista['nombre']; 
                                            echo ($lecturista['supervisor']==true)? '<b>Lecturista Supervisor (Muestra)</b>' : '';
                                            ?></td>
                                            <td><?php echo $lecturista['cantLecturas']; ?></td>
                                            <td><?php echo $lecturista['SolFchEj'] ?></td>
                                            <td><?php echo $lecturista['cantLecturasEj'] ?></td>
                                            <td>
                                                <a href="<?php echo base_url() .'toma_estado/orden/avance/'.$OTTomaEstado['OrtId'].'/suborden/'.$lecturista['SolCod']?>">
                                                <small class="label label-success"><?php echo $lecturista['avance']; ?>%</small>
                                                <div class="progress xs progress-striped active">
                                                    <div class="progress-bar progress-bar-success" style="width: <?php echo $lecturista['avance']; ?>%"></div>
                                                </div>
                                                </a>
                                            </td>
                                            <td><?php echo $lecturista['cantObs'] ?></td>
                                        </tr>
                                    <?php } ?>
                                </tbody>
                            </table>
