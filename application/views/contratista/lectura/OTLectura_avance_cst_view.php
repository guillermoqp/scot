        ...
        <div id="impresion">
            ...
            <div class="row no-print invoice-info">
                <div class="col-xs-12">
                    ...
                    <?php foreach ($ciclos as $ciclo) { ?>
                        <h4>Sub Ciclo: <?php echo $ciclo["GprCod"]; ?></h4>
                        <div class="table-responsive">
                                ...
                                <tbody>
                                    <?php foreach ($ciclo['lecturistas'] as $lecturista) { ?>
                                        <tr>
                                            ...
                                            <td><?php echo $lecturista['nombre']; ?></td>
                                            <td><?php echo $lecturista['cantLecturas']; ?></td>
                                            <td><?php echo $lecturista['SolFchEj'] ?></td>
                                            <td><?php echo $lecturista['cantLecturasEj'] ?></td>
                                            <td>
                                                <a href="<?php echo base_url() .'cst/toma_estado/orden/avance/'.$OTTomaEstado['OrtId'].'/suborden/'.$lecturista['SolCod']?>">
