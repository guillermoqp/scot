                    ...
                    <div class="box-body table-responsive">
                        <div id="impresion">
                            <div class="box-header">
                                ...
                                <p style="margin: 0px;">PROCESO DISTRIBUCIÓN DE RECIBOS Y COMUNICACIONES AL CLIENTE</p><br>
                            </div><!-- /.box-header -->
                            <div class="row">   
                                <div class="col-md-12" style="text-align: center">
                                    <p style="margin: 0px;">CRONOGRAMA PARA DISTRIBUCIÓN DE RECIBOS Y COMUNICACIONES AL CLIENTE POR: <?php echo $NivelSeleccionado['NgrDes'] ?> | Periodo : <?php echo $mes ?> , <?php echo strtoupper($this->utilitario_cls->nombreMes($mes)) . ' / ' . $anio ?></p><br>
                                </div>    
                            </div>
                            <table id="example1" class="table table-bordered table-striped" aria-describedby="example1_info">
                                <thead>
                                    <tr role="row">
                                        ...
                                        <?php } ?>
                                        <th style="border: 1px solid #000; padding: 5px;">Suministros</th>
                                        <th style="border: 1px solid #000; padding: 5px;">Fecha Lectura</th>
                                        <th style="border: 1px solid #000; padding: 5px;">Fecha de Consistencia de Lecturas</th>
                                        <th style="border: 1px solid #000; padding: 5px;">Fecha Carga Data P/Fact.</th>
                                        <th style="border: 1px solid #000; padding: 5px;">Fecha CALCULO, Control Anomalias</th>
                                        <th style="border: 1px solid #000; padding: 5px;">Fecha Impresión, Emision Recibos</th>
                                        <th style="border: 1px solid #000; padding: 5px;">Fecha Distribuc. Recibos / Actul. en red datos</th>
                                    </tr>
                                </thead>
                                <tbody role="alert" aria-live="polite" aria-relevant="all">
                                    <?php foreach ($gruposPredio as $grupoPredio) { ?>
                                        <tr>
                                            ...
                                            <td style="border: 1px solid #000; padding: 5px;">
                                                <?php echo $lecturaAnual[$grupoPredio['GprId']]['DlaFchTm']; ?>
                                            </td>
                                            <td style="border: 1px solid #000; padding: 5px;">
                                                <?php echo $lecturaAnual[$grupoPredio['GprId']]['AuxFchCo']; ?>
                                            </td>
                                            <td style="border: 1px solid #000; padding: 5px;">
                                                <?php echo $lecturaAnual[$grupoPredio['GprId']]['AuxFchCo']; ?>
                                            </td>
                                            <td style="border: 1px solid #000; padding: 5px;">
                                                <?php echo $cronograma[$grupoPredio['GprId']]['DdpFchCal']; ?>
                                            </td>
                                            <td style="border: 1px solid #000; padding: 5px;">
                                                <?php echo $cronograma[$grupoPredio['GprId']]['DdpFchImp']; ?>
                                            </td>
                                            <td style="border: 1px solid #000; padding: 5px;">
                                                <?php echo $cronograma[$grupoPredio['GprId']]['DdpFchDis']; ?>
                                            </td>
                                        </tr>
                                    <?php } ?>
                                </tbody>
