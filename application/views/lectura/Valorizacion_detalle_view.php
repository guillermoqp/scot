                            ...
                            <tbody>
                                <?php foreach ($ordenes as $orden) { ?>
                                    <tr>
                                        ...
                                        <td>
                                            <a href="<?php echo base_url() . 'toma_estado/valorizacion/detalle/' . $valorizacion['VlrId'].'/orden/'.$orden['OrtId']; ?>" class="btn btn-default btn-flat" data-toggle="tooltip" data-placement="bottom" title="Detalle">
                                                <i class="fa fa-eye"></i>
                                            </a>
                                        </td>
                                    </tr>
