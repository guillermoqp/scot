...
<section class="content">
    <div class="row">
        <div class="col-xs-12">
            ...
            <?php } ?>
            <?php if ($this->acceso_cls->tienePermiso('editar_cron_distribucion_periodo')) { ?>
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            <div class="control-group">
                                <a href="<?php echo base_url() ?>distribucion/cronograma_periodo/nuevo" class="btn btn-info btn-flat"><i class="fa fa-pencil"></i> Registrar Nuevo Cronograma Periodo</a>
                            </div>
                        </div>
                    </div> 
                </div>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <?php if ($this->acceso_cls->tienePermiso('ver_cron_distribucion_periodo')) { ?>
                                            <a href="<?php echo base_url() . 'distribucion/cronograma_periodo/ver/' . $cronograma['CdpId']; ?>" class="btn btn-default btn-flat" data-toggle="tooltip" data-placement="bottom" title="Ver/Imprimir/Detalle">
                                                <i class="fa fa-info"></i>
                                            </a>
                                        <?php } ?>
                                        <?php if ($this->acceso_cls->tienePermiso('editar_cron_distribucion_periodo')) { ?>
                                            <a href="<?php echo base_url() . 'distribucion/cronograma_periodo/editar/' . $cronograma['CdpId']; ?>" class="btn btn-default btn-flat" data-toggle="tooltip" data-placement="bottom" title="Editar">
