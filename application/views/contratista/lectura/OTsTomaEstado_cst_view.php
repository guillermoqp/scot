                        ...
                        <tbody class="tbodyP" role="alert" aria-live="polite" aria-relevant="all">
                                ...
                                <tr>
                                    ...
                                    <td><b>Total: </b><?php echo $ordenTrabajo['cantidad']['lec_reg']+$ordenTrabajo['cantidad']['lec_sup']+$ordenTrabajo['cantidad']['lec_ati']; ?>
                                        ...
                                        <br>Atípicos: <?php echo $ordenTrabajo['cantidad']['lec_ati']; ?>
                                    </td>
                                    <td>
                                    ...
                                    <?php $estilos = array('eje' => 'primary', 'rec' => 'info', 'no_rec' => 'danger', 'cer' => 'success', 'liq' => 'warning'); ?>
                                        <a href="<?php echo base_url() .'cst/toma_estado/orden/avance/'.$ordenTrabajo['OrtId']?>"><small class="label label-<?php echo $estilos[$ordenTrabajo['DprCod']]; ?>"><?php echo $ordenTrabajo['avance']; ?>%</small>
                                    ...
                                    <td>
                                        <?php if ($this->acceso_cls->tienePermiso('ver_orden_lectura')) { ?>
                                            <a href="<?php echo base_url() . 'cst/toma_estado/orden/ver/' . $ordenTrabajo['OrtId']; ?>" class="btn btn-default btn-flat" data-toggle="tooltip" data-placement="bottom" title="Ver">
                                            <i class="fa fa-eye"></i>
                                        <?php } ?>
                                        <?php if ($this->acceso_cls->tienePermiso('ver_orden_lectura')) { ?>
                                            <a href="<?php echo base_url() .'cst/toma_estado/orden/avance/'.$ordenTrabajo['OrtId']?>" class="btn btn-default btn-flat" data-toggle="tooltip" data-placement="bottom" title="Avance">
