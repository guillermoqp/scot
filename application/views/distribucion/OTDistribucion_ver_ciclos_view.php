    ...
    <hr style="margin-top:10px;margin-bottom: 10px;">
      ...
      <div class="row invoice-info">
        <div class="col-sm-12">
            ...
            <h4>Sub Ciclos de la Orden de Trabajo de Distribucion de Recibos y Comunicaciones a ejecutar</h4>
      ...
      <div class="row no-print invoice-info">
        <div class="col-sm-12">
            ...
            <?php if(empty($subordenes)) { ?>
                <p>La Contratista aún no ha asignado las Sub-Ordenes a los Distribuidores.</p>
            <?php } else { ?>
            <div class="table-responsive">
