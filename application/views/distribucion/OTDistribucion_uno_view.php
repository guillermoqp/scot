            ...
            <form id="mainForm" name="prueba" role="form" method="post" action="<?php echo str_replace('/index.php', '', current_url()); ?>"> 
                ...
                <div class="box">
                    <div class="box-header">
                        <h3 class="box-title">Orden de Trabajo de Distribución de Recibos y Comunicaciones al Cliente</h3>              
                    </div><!-- /.box-header -->
                    <div class="box-body">
                        <div class="row">
                            <div class="col-md-6">
                    ...
                    <div class="box">
                        ...
                        <div class="box-body">
                            <div class="row"> 
                                <div class="col-md-3">
                                    Rendimiento promedio:<input type="text" class="form-control" value="<?php echo $_SESSION['orden']['rendimiento']; ?>" disabled=""/>
                                </div>    
                                <div class="col-md-3">
                                    N° Total de Distribuidores :<input type="text" class="form-control" value="<?php echo $_SESSION['orden']['totalLecturistas']; ?>" disabled=""/>
                                </div>
                                <div class="col-md-3">
                                    N° Subordenes:<input type="text" class="form-control" value="<?php echo $_SESSION['orden']['subordenesAcumulado']; ?>" disabled=""/>
                                </div> 
                                <div class="col-md-3">
                                    Distribuciones Totales de la Orden:<input type="text" class="form-control" value="<?php echo $_SESSION['orden']['lecturasAcumulado']; ?>" disabled=""/>
                                </div> 
                            </div><br>
                            <div class="row">
                ...
                <div class="box">
                    <div class="box-body">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    <input type="checkbox" value="suborden" name="supervision" class="flat-red" <?php echo $_SESSION['orden']['supervision'] ? 'checked' : '' ?>>Añadir Suborden de Supervisión y Control de Calidad de las Distribuciones.
                                    <br> ( <b><?php echo isset($_SESSION['orden']['tamanioMuestra']) ? 'Tamaño Muestra : '.$_SESSION['orden']['tamanioMuestra'] : '' ?> Distribuciones (Entrega aleatoria de envíos con constancia de entrega por lotes de distribución). </b> )
                                </div>
                            </div>
                        </div>
                    </div>
