    ...
    <div class="row">
        <form method="post"> 
            <div class="col-xs-12">
                ...
                <div class="row">   
                    <div class="col-md-4">
                        Nro Suministros: <input id="nroSuministros" name="nroSuministros" type="number" step="any" class="form-control" value="<?php echo $_SESSION['ordenP']['detalle'][$nroDia]['lecturasRealizar']; ?>" disabled=""/>
                    </div>   

                    <div class="col-md-4">
                        Nro Lecturistas Necesarios: <input type="text" id="nroLecturistasN" name="nroLecturistasN" class="form-control" value="<?php echo $_SESSION['ordenP']['detalle'][$nroDia]['nroLecturistas']; ?>" disabled=""/>
                    </div> 

                    <div class="col-md-4">
                        Promedio Lecturas por Lecturista:<input type="text" id="promLectxLectu" name="promLectxLectu" class="form-control" value="<?php echo ceil($_SESSION['ordenP']['detalle'][$nroDia]['lecturasRealizar'] / $_SESSION['ordenP']['detalle'][$nroDia]['nroLecturistas']); ?>" disabled=""/>
                    </div> 
                </div>
                <!--
                <div class="row">   
...
$(document).ready(function ()
{
        ...
        $(document).on("click", "#detalle", function ()
        {
            ...
            $.ajax({
                url: "<?php echo base_url() . 'toma_estado/get_detalle_x_suborden_jsonP'; ?>",
                type: "POST",
