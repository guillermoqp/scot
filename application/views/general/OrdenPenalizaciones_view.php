                ...
                <div class="col-md-6">
                    <div class="form-group">
                        <div class="control-group">
                            <a href="<?php echo base_url().$padre.'/'.$hijo.'/'.$ordenTrabajoEdit['OrtId'].'/penalizacion/nuevo'; ?>" class="btn btn-info btn-flat"><i class="fa fa-pencil"></i> Registrar Nueva Penalización a la Orden de Trabajo</a>
                        </div>
                    </div>
                </div> 
            </div>
                                ...
                                <tr>
                                    ...
                                    <td class=" ">
                                        <?php if ($this->acceso_cls->tienePermiso('editar_orden')) { ?>
                                            <a href="<?php echo base_url().$padre.'/'.$hijo.'/'.$ordenTrabajoEdit['OrtId'].'/penalizacion/editar/'.$penalizacion['PnzId']; ?>" class="btn btn-default btn-flat" data-toggle="tooltip" data-placement="bottom" title="Editar">
...
$(document).ready(function()
{
   $(document).on('click', 'a', function(event) 
   {
        ...
        $('#idelim').attr('action',"<?php echo base_url().$padre.'/'.$hijo.'/'.$ordenTrabajoEdit['OrtId'].'/penalizacion/eliminar/'; ?>"+penalizacionId);
    });
});
</script>