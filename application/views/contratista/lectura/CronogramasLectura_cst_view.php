...
<section class="content">
    <div class="row">
        <div class="col-xs-12">
            ...
            <?php } ?>
            <?php if ($this->acceso_cls->tienePermiso('editar_cronograma_anual')) { ?>
                <div class="row">
                    <div class="col-md-6">
            ...
            <div class="box">
                ...
                <div class="box-body">
                    <div class="table-responsive">
                        <table id="CronogramasLectura" class="table table-bordered table-striped" aria-describedby="example1_info">
                            <thead>
                                    ...
                                    <tr>
                                        ...
                                        <td class=" ">
                                            <?php if ($this->acceso_cls->tienePermiso('ver_cron_lectura_anual')) { ?>
                                                <a href="<?php echo base_url() . 'cst/toma_estado/cronograma_anual/ver/' . $cronograma['ClaId']; ?>" class="btn btn-default btn-flat" data-toggle="tooltip" data-placement="bottom" title="Detalle">
                                                    <i class="fa fa-info"></i>
                                                </a>
                                            <?php } ?>
                                            <?php if ($this->acceso_cls->tienePermiso('editar_cron_lectura_anual')) { ?>
                                                <a href="<?php echo base_url() . 'cst/toma_estado/cronograma_anual/editar/' . $cronograma['ClaId']; ?>" class="btn btn-default btn-flat" data-toggle="tooltip" data-placement="bottom" title="Editar">
                                                    <i class="fa fa-edit"></i>
                                                </a>
                                            <?php } ?>
                                            <?php if ($this->acceso_cls->tienePermiso('aprobar_cron_lectura_anual') && $cronograma['ClaApr'] == 'f') { ?>
                                                <a href="<?php echo base_url() . 'cst/toma_estado/cronograma_anual/aprobar/' . $cronograma['ClaId']; ?>" class="btn btn-default btn-flat" data-toggle="tooltip" data-placement="bottom" title="Aprobar">
                                                    <i class="fa fa-edit"></i>
                                                </a>
                                            <?php } ?>
                                            <?php if ($this->acceso_cls->tienePermiso('eliminar_cron_lectura_anual')) { ?>
                                                <a id="eliminar" idCronograma="<?php echo $cronograma['CroId']; ?>" class="eliminar btn btn-default btn-flat" data-toggle="tooltip" data-placement="bottom" title="Eliminar">
            ...
            swal({
                ...
                closeOnConfirm: false
                    ...
                    function ()
                    {
                        ...
                        window.location.href = "<?php echo base_url() . 'cst/toma_estado/cronograma_anual/eliminar/'; ?>" + idCronograma;
