            ...
            <form id="mainForm" name="prueba" role="form" method="post" action="<?php echo str_replace('/index.php', '', current_url()); ?>"> 
                ...
                <div class="box">
                    <div class="box-header">
                        <h3 class="box-title">Orden de Trabajo de Toma de Estado de suministros</h3>              
                    </div><!-- /.box-header -->
                    <div class="box-body">
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <div class="form-group">
                                    <div class="control-group"> 
                                        <?php foreach ($niveles as $key => $nivel) { ?>
                                            <input id="nivel" name="nivel" type="radio" onchange="enviarForm('nivel')" value="<?php echo $nivel['NgrId'] ?>" <?php echo ($detCron['ClpNgrId'] == $nivel['NgrId']) ? 'checked' : 'disabled' ?>><?php echo $nivel['NgrDes'] ?>   
                                        <?php } ?>
                                    </div>
                                </div>  
                            </div>
                            ...
                            <?php #var_dump($_SESSION['ordenP']['gruposPredio']); ?>
                                ...
                                <?php if (isset($esUltimoNivel)) { ?>
                                        ...
                                        <div class="form-group">
                                            <div class="control-group">
                                                <div class="input-group">
                                                    ...
                                                    <select id="buscarGruposPredio" name="buscarGruposPredio" class="form-control" onchange="enviarForm('buscarGruposPredio')" <?php echo isset($_SESSION['orden']['bloqueado']) ? 'readonly' : '' ?> >
                                                        <?php foreach ($gruposPredio as $grupoPredio) { ?>
                                                            <option value="<?php echo $grupoPredio['GprId']; ?>" <?php echo ($_SESSION['ordenP']['buscarGruposPredio'] == $grupoPredio['GprId']) ? 'selected' : '' ?> <?php echo isset($_SESSION['orden']['bloqueado']) ? 'readonly' : '' ?>><?php echo $grupoPredio['GprCod']; ?></option>
                                                            <?php } ?>
                                                    </select> 
                                                </div>
                                            </div>
                                    ...
                                    <div class="col-md-3">
                                        ...
                                        <div class="form-group">
                                            <div class="control-group">
                                                <div class="input-group">
                                                    <select id="gruposPredio" name="gruposPredio[]" class="select2" multiple="multiple" data-placeholder="Seleccione SubCiclo" <?php echo isset($_SESSION['ordenP']['bloqueado']) ? 'readonly' : '' ?> style="width: 100%;">
                                        ...
                                        <div class="form-group">
                                            <div class="control-group">
                                                <div class="input-group">
                                                    ...
                                                    <select id="gruposPredio" name="gruposPredio" class="form-control" onchange="enviarForm('gruposPredio')" <?php echo isset($_SESSION['ordenP']['bloqueado']) ? 'readonly' : '' ?> >
                                                        <?php if (!isset($_SESSION['ordenP']['gruposPredio'])) { ?>
                                                            <?php foreach ($gruposPredio as $grupoPredio) { ?>
                                                            <option value="<?php echo $grupoPredio['GprId']; ?>" <?php echo ($_SESSION['ordenP']['gruposPredio'] == $grupoPredio['GprId']) ? 'selected' : '' ?> <?php echo isset($_SESSION['ordenP']['bloqueado']) ? 'readonly' : '' ?>><?php echo $grupoPredio['GprCod']; ?></option>
                                                            <?php } ?>
                                                        <?php } else { ?>
                                                        <?php foreach ($gruposPredio as $grupoPredio) { ?>
                                                            <option value="<?php echo $grupoPredio['GprId']; ?>" <?php echo ($_SESSION['ordenP']['gruposPredio'] == $grupoPredio['GprId']) ? 'selected' : '' ?> <?php echo isset($_SESSION['ordenP']['bloqueado']) ? 'readonly' : '' ?>><?php echo $grupoPredio['GprCod']; ?></option>
                                    ...
                                    <div class="control-group">
                                        ...
                                        <div class="controls">
                                            <div class="input-group">
                                                ...
                                                <input id="OrtNum" name="OrtNum" type="text" class="form-control" value="<?php echo $_SESSION['ordenP']['numero']; ?>" readonly/>
                                            </div><!-- /.input group -->
                                        </div>
                                    </div>
                                </div>    
                                ...
                                <div class="form-group">
                                    <div class="control-group">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input id="OrtEntr" name="OrtEntr" type="text" class="form-control" value="<?php echo $_SESSION['ordenP']['entregado']; ?>" readonly=""/>
                                        </div>
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <textarea id="OrtDes" name="OrtDes" class="form-control" rows="3" ><?php echo $_SESSION['ordenP']['descripcion']; ?></textarea>
                                    </div>       
                                </div>
                            </div> 
                        </div>
                                ...
                                <div class="form-group"> 
                                    <div class="control-group">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <select id="OrtAnio" name="OrtAnio" class="form-control" onchange="enviarForm('anio')" <?php echo isset($_SESSION['ordenP']['bloqueado']) ? 'readonly' : '' ?> >
                                                <?php foreach ($anios as $anioitem) { ?>
                                                    <option value="<?php echo $anioitem ?>"<?php echo ($_SESSION['ordenP']['anio'] == $anioitem) ? 'selected' : ''; ?>><?php echo $anioitem ?></option>
                                                <?php } ?>
                                            </select>
                                        </div><!-- /.input group -->
                                    </div> 
                                ...
                                <div class="form-group">
                                    <div class="control-group">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <select id="OrtPrd" name="OrtPrd" class="form-control" onchange="enviarForm('periodo')" <?php echo isset($_SESSION['ordenP']['bloqueado']) ? 'readonly' : '' ?>  >
                                                <?php foreach ($periodos as $periodo) { ?>
                                                    <option value="<?php echo $periodo['PrdId'] ?>"<?php echo ($_SESSION['ordenP']['periodo'] == $periodo['PrdId']) ? 'selected' : ''; ?>><?php echo $periodo['PrdCod'] ?></option>
                                                <?php } ?>
                                            </select>
                                        </div>
                                    </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                       ...
                                       <input id="OrtFchEj" name="OrtFchEj" type="text" class="form-control" onchange="enviarForm('fecha')" data-toggle="tooltip" title="Dato necesario para ingresar Fecha y hora Máxima de Recepción"  <?php echo isset($_SESSION['ordenP']['bloqueado']) ? 'readonly' : '' ?>/>   
                                    </div>
                                </div>
                            </div>
                        </div>    
                    ...
                    <div class="box">
                        ...
                        <div class="box-body">
                            <div class="row"> 
                                <div class="col-md-3">
                                    Rendimiento por Lecturista:<input type="text" class="form-control" value="<?php echo $_SESSION['ordenP']['rendimiento']; ?>" disabled=""/>
                                </div>    
                                <div class="col-md-3">
                                    N° Total de Lecturistas :<input type="text" class="form-control" value="<?php echo $_SESSION['ordenP']['totalLecturistas']; ?>" disabled=""/>
                                </div>
                                <div class="col-md-3">
                                    N° Subordenes:<input type="text" class="form-control" value="<?php echo $_SESSION['ordenP']['subordenesAcumulado']; ?>" disabled=""/>
                                </div> 
                                <div class="col-md-3">
                                    Lecturas Totales de la Orden:<input type="text" class="form-control" value="<?php echo $_SESSION['ordenP']['lecturasAcumulado']; ?>" disabled=""/>
                                </div> 
                            </div><br>
                            <?php #var_dump($_SESSION['ordenP']['detalle']) ?>
                            <div class="row">
                                <div class="col-md-12 table-responsive">
                                    <table id="ciclos" class="table table-bordered table-striped">
                                        ...
                                        <tbody>
                                            <?php
                                            $cant = 0;
                                            foreach ($_SESSION['ordenP']['detalle'] as $dia => $ordenDia) {
                                                ?>
                                                <tr>
                                                    <td> <?php echo $dia ?></td>
                ...
                <div class="box">
                    <div class="box-body">
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <textarea id="OrtObs" name="OrtObs" class="form-control" rows="3"><?php echo $_SESSION['ordenP']['observaciones']; ?></textarea>
                                    </div>       
                                </div>
                            </div> 
                        </div>
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    <input type="checkbox" value="suborden" name="supervision" class="flat-red" <?php echo $_SESSION['ordenP']['supervision'] ? 'checked' : '' ?>>Añadir Suborden de Supervisión y Control de Calidad de las Lecturas.
                                    <br> ( <b><?php echo isset($_SESSION['ordenP']['tamanioMuestra']) ? 'Tamaño Muestra : '.$_SESSION['ordenP']['tamanioMuestra'].' Lecturas.' : '' ?></b> )
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <a href="<?php echo base_url() ?>toma_estado/orden/limpiar/<?php echo $detCron['DlpId'] ?>" type="reset" class="btn btn-block btn-default btn-flat">Limpiar</a>
                    </div>
                </div>
            </form>
        </div>
...
$(document).ready(function ()
{
    ...
    <?php if (isset($_SESSION['ordenP']['detalle'])) { ?>
    ...
    <?php if(is_array($_SESSION['ordenP']['gruposPredio'])) { ?>
    var subciclosSeleccionados = <?php echo json_encode($_SESSION['ordenP']['gruposPredio']); ?>; 
    ...
    $(document).on("click", "#detalle", function ()
    {
        ...
        window.open("<?php echo base_url() . 'toma_estado/orden/nuevo/detalle_cicloP/'; ?>" + idCiclo, "_blank", "toolbar=yes, scrollbars=yes, resizable=yes, top=50, left=80, width=1100, height=800");
    });
    $(document).on("click", "#eliminar", function ()
    {
        var idCiclo = $(this).attr('ciclo');
        window.location.replace("<?php echo base_url() . 'toma_estado/orden/nuevo/'.$detCron['DlpId'].'?eliminar=' ?>" + idCiclo);
    });
    <?php if (isset($_SESSION['ordenP']['fchEj'])) { ?>
        $('#OrtFchEj').val("<?php echo $_SESSION['ordenP']['fchEj']; ?>");
    <?php } ?>
        
//            var mes = <?php echo $perio['PrdOrd']; ?>;
//            alert(mes);
